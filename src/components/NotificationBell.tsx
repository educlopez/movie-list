  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-emerald-500 px-1 font-bold text-[10px] text-white">
      ...
      {showPanel && mounted
        ? createPortal(
            <>
              ...
              />
              <div className="fixed top-16 right-4 z-[100] max-h-[70vh] w-80 overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-xl sm:right-8 dark:border-zinc-700 dark:bg-zinc-900">
                {/* Header */}
                <div className="flex items-center justify-between border-zinc-100 border-b px-4 py-3 dark:border-zinc-800">
                  <h3 className="font-semibold text-sm text-zinc-900 dark:text-white">
                    Notificaciones
                  </h3>
                  {unreadCount > 0 && (
                    <button
                      className="text-emerald-500 text-xs transition-colors hover:text-emerald-600"
                      onClick={markAllRead}
                      type="button"
                    >
